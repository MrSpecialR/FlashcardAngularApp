...
import { AdministratorGuard } from './authentication/guards/administrator.guard';
...
const routes : Routes = [
  ...
  { path: 'languages/create', component: LanguageCreateFormComponent, canActivate: [AdministratorGuard] }
]
